 ...
 *
 * For example, given x = "AbcDE" and y = "ABCDE". In x we can convert b and delete c to match y.
 * If x = "AbcDE" and y = "AFDE", matching is not possible because letters may only be capitalized or discarded, not changed.
 */
