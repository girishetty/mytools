...
void FibonacciGenerator::raiseToThePower(const vector<vector<unsigned long long>>& matrix, int n) {
  ...
  // Note that matrixToThePower saevs the power and corresponding power matrix for the future computation.
  ...
  // For example, is n is 13, which means we have raised the matrix to 1, 4 and 8 and saved it already
