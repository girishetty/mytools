...
void BSTNode::DisplayPostOrder() const{
  if (iLeft) {
    iLeft->DisplayPostOrder();
  }
  if (iRight) {
    iRight->DisplayPostOrder();
  }
  cout<<iValue<<"  ";
}

void BSTNode::DisplayPreOrder() const{
  cout<<iValue<<"  ";
  if (iLeft) {
    iLeft->DisplayPreOrder();
  }
  if (iRight) {
    iRight->DisplayPreOrder();
  }
}
