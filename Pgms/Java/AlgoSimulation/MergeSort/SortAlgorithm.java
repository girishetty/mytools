...
class SortAlgorithm {
	...
	parent.pause(parent.h1, parent.h2, parent.c1, parent.c2);
    }
	...
	parent.pause(H1, parent.h2, parent.c1, parent.c2);
    }
	...
	parent.pause(H1, H2, parent.c1, parent.c2);
    }

    /**
     * Pause for a while and mark item 1 & 2 & comparisons.
     */
    protected void pause(int H1, int H2, int C1, int C2) throws Exception {
	if (stopRequested) {
	    throw new Exception("Sort Algorithm");
	}
	parent.pause(H1, H2, C1, C2);
    }
