...
//#include <locale.h>
#include <localefwd.h>
#include <std_cstring.h>		// For strcmp.
//#include <string>
#include <atomicity.h>
#include <gthr.h>
  ...
  */
  ...
  template<typename _Facet>
	  locale::locale(const locale& __other, _Facet* __f) /*:
		none(0) , ctype(1L << 0), numeric(1L << 1), collate(1L << 2)
		time(1L << 3), monetary(1L << 4), messages(1L << 5), 
		all(ctype | numeric | collate | time | monetary | messages);*/
