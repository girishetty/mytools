...
private:
	...
	CreateSingleton(const CreateSingleton& );
...
Singleton* CreateSingleton::instance = NULL;
//Create a global object of type CreateSingleton
static CreateSingleton global;
