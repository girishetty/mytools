...
public class ServerWebPageIndex extends ServerWebPage {

    ServerWebPageIndex() {
        mPageName = StartActivity.HTML_PATH + "index.html";
    }
    ...
    public void createWebPage() {
        try {
            ...
            if (!file.exists()) {
                //index.html is not there, so create one
                ...
                webPage.newLine();
                webPage.write("Select What you want to Configure:");
                webPage.newLine();
                webPage.write("<br />");
                webPage.newLine();
                webPage.write("<input type=\"radio\" name=\"config\" value=\"wifi\" /> WiFi<br />");
                webPage.newLine();
                webPage.write("<input type=\"radio\" name=\"config\" value=\"resolution\" /> Resolution<br />");
                webPage.newLine();
                webPage.write("<input type=\"submit\" value=\"submit\" />");
                webPage.newLine();
                webPage.write("</form>");
                webPage.newLine();
                webPage.write("</body>");
