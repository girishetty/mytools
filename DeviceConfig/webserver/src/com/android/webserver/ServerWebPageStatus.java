...
public class ServerWebPageStatus extends ServerWebPage {

    ServerWebPageStatus() {
        mPageName = StartActivity.HTML_PATH + "status.html";
    }
    ...
    public void createWebPage() {
        try {
            ...
            if (!file.exists()) {
                //status.html is not there, so create one
                ...
                webPage.newLine();
                webPage.write("BG2CD Successfully Connected to the WiFi Access Point");
                webPage.newLine();
                webPage.write("</form>");
                webPage.newLine();
                webPage.write("</body>");
