...
public class ServerWebPage403 extends ServerWebPage {

    ServerWebPage403() {
        mPageName = StartActivity.HTML_PATH + "403.html";
    }
    ...
    public void createWebPage() {
        try {
            ...
            if (!file.exists()) {
                //403.html is not there, so create one
